...
var ids = [
    new Clip("#0 Kras", "W-_WMcXIstk", 54.232),
    new Clip("#1 elim", "XM3iEUSXN_0", 54.247),
    new Clip("#2 Barack Obama", "SjlJWB-Rq1U", 54.248),
    new Clip("#3 NotHamamoto", "QWgC5Wi7hRw", 54.255),
    new Clip("#4 blamo", "79lodHT9RH0", 54.264),
    new Clip("#5 The Sandee", "92MR6v1eE9A", 54.29),
    new Clip("#6 Otiskk", "FvW7vFYRGJE", 54.293),
    new Clip("#7 antsy", "sPOujodRgLE", 54.311),
    new Clip("#8 The Unholy Baux", "ci7MXiC06UY", 54.319),
    new Clip("#9 Tyronus", "j1FxSghxu_I", 54.32),
    new Clip("#10 FÃ©IRE", "BXYw8tO-FTQ", 54.339),
    new Clip("#11 hayleyuwu", "rOI9QMutJyU", 54.341),
    new Clip("#12 oofygoo", "_fC-CucmsJg", 54.348),
    new Clip("#13 [MarshMellow]", "Sdx_Sx1W9yk", 54.37),
    new Clip("#14 cflat", "oMvyC0T9-q8", 54.374),
    new Clip("#15 Shatterglass27", "JLv5lHGRQ3o", 54.377),
    new Clip("#16 MapleTyger", "bHPdgSmj5S8", 54.389),
    new Clip("#17 Spaceman", "vXm7_KQRMIQ", 54.435),
    new Clip("#18 tydogzilla", "g3KZ6Zxr3DA", 54.462),
    new Clip("#19 KibbyShelton", "aVkBK1wYZHs", 54.462),
    new Clip("#20 amber", "ED-zDIeCKvg", 54.48),
    new Clip("#21 Empyrean Eevee", "HHMC-iURxAA", 54.559),
    new Clip("#22 Suado Cowboy", "GY6vOfHRHPU", 54.56),
    new Clip("#23 Graham Crackers", "MqSHJ-h5XZo", 54.561),
    new Clip("#24 nico", "iA8EvRxKPxg", 54.565),
    new Clip("#25 KING BOOLEAN", "m_ei75EG4ro", 54.566),
    new Clip("#26 cha", "VkNms_jcabE", 54.57),
    new Clip("#27 [BEAR] ", "pExS8i2BtDA", 54.576),
    new Clip("#28 nyanezt", "C5S7BMBWD7Q", 54.587),
    new Clip("#29 Burger King Foot Lettuce", "noCmMNc1eig", 54.588),
    new Clip("#30 áƒ¦ Jun.", "i8L58Qcou4c", 54.597),
    new Clip("#31 Triploon", "Q1AqWCZHh_I", 54.602),
    new Clip("#32 hammock", "sZbRGmFpZhI", 54.639),
    new Clip("#33 Syc0b0b", "cBNu9agCMDk", 54.642),
    new Clip("#34 IGOR", "YUrIXSul-U8", 54.642),
    new Clip("#35 Asomn", "LsLwZ77pfmo", 54.662),
    new Clip("#37 technomo", "tAmXHX_iXHA", 54.675),
    new Clip("#38 MoonshineRising", "1H8jPor00aM", 54.675),
    new Clip("#39 John Jim", "U82PyfQhQ3s", 54.682),
    new Clip("#40 Ororc", "bPcuziXV1EQ", 54.685),
    new Clip("#41 ashdu0j", "k1D421lzdCg", 54.692),
    new Clip("#42 eva", "PoMrNn4nlQs", 54.694),
    new Clip("#43 Savarin", "_4JWWYj6TAQ", 54.702),
    new Clip("#44 General Moron", "lfXFKtS24BA", 54.713),
    new Clip("#45 Oisincool", "vg4MfW1hd_I", 54.724),
    new Clip("#46 AussieAlex", "7obGkR6eRPY", 54.728),
    new Clip("#47 MOLD", "5UCvrhFzRAo", 54.732),
    new Clip("#48 AFSilver", "UBTG41umljk", 54.754),
    new Clip("#49 poorfreyja", "7Jpp4rqsMIg", 54.768),
    new Clip("#50 spyguy3000", "YiC1xf9pnks", 54.769),
    new Clip("#51 Honk", "E0gVJup3FmU", 54.778),
    new Clip("#52 Mochiman514", "ZD7t8hbJ5bA", 54.779),
    new Clip("#53 LeManzana", "BuOvVkkz0xg", 54.782),
    new Clip("#54 slender", "OLNYqS8uNQQ", 54.787),
    new Clip("#55 junkcann", "z806nlkBW6E", 54.788),
    new Clip("#56 pyroman50", "I80WEuhB7E0", 54.799),
    new Clip("#57 SOOOOOAPYMEiSTER", "E31QgfGE-Jc", 54.826),
    new Clip("#58 robsan", "kxJEVc4aHxk", 54.854),
    new Clip("#59 bug / @space_heavy", "pZWcymqLe4Y", 54.866),
    new Clip("#60 Xnery", "R14KrHNmtcE", 54.867),
    new Clip("#61 KorotaGecko", "pOYNEugO9Ys", 54.871),
    new Clip("#62 Endy", "S7DUXHZcAKc", 54.879),
    new Clip("#63 Luleta", "10gAvqxhIP4", 54.88),
    new Clip("#64 Orange", "Rv8WLyc4sgc", 54.884),
    new Clip("#65 dex", "I9W2IjjkI9A", 54.893),
    new Clip("#66 Rakku", "rSsmHLYh-_o", 54.896),
    new Clip("#67 NightPixel", "NzI9RKkToTo", 54.912),
    new Clip("#68 Blizzy360", "0SHQuIU6e3A", 54.912),
    new Clip("#69 GeneralAlias", "6z7ndyBlN-s", 54.917),
    new Clip("#70 aubreygine", "BVcxJ6DjGjg", 54.921),
    new Clip("#71 Joey", "pFfrW_rz1YU", 54.925),
    new Clip("#72 kn", "O_aRR562igA", 54.936),
    new Clip("#73 Quill", "5sgsPZq446Q", 54.937),
    new Clip("#74 FRAGBOMBBLITZ", "xjb-htz6IyM", 54.946),
    new Clip("#75 Cosmic sR", "7buTESfhnEY", 54.957),
    new Clip("#76 fourlow", "QIo2eqDSQuc", 54.976),
    new Clip("#77 colossal", "2fk9AuNwYWc", 54.978),
    new Clip("#78 ModestMorning", "YtrcNv-HbNg", 54.985),
    new Clip("#79 MrTheWizard", "FycttBhB4m4", 54.988),
    new Clip("#80 Mirory", "wnLdHX9_QUk", 55.044),
    new Clip("#81 nebuden", "KJX6MZWUZhw", 55.252),
    new Clip("#82 Dochnicht", "JEZZwwVM3UM", 55.436),
    new Clip("#83 songokori", "A8iw4IQZMpk", 55.92),
    new Clip("#84 RayitoMSF", "zeFv76aHB2U", 56.209),
    new Clip("#85 skull", "o5FZbRS54dE", 56.222),
    new Clip("#86 kiwi", "xwpqSqMjIGI", 56.27),
    new Clip("#87 Jackson Fumblington", "hyhU9rfuY8Y", 56.541),
    new Clip("#88 ipad_john", "dilLh_0iN_Q", 56.866),
    new Clip("#89 monchh", "OO2-sYos4P0", 57.172),
    new Clip("#90 KennytheHedgehog", "T3SwrNvnmVA", 57.195),
    new Clip("#91 acres", "y6dXqzXkjac", 57.391),
    new Clip("#92 Lakki", "nd7Jj4Xk7f4", 57.402),
    new Clip("#93 specialinsect", "_wt8pjMNo_g", 60.207),
    new Clip("#94 fleura", "Z_GmZy4vxzY", 60.703),
    new Clip("#95 danmar33", "kWul1Qq9xcQ", 60.963),
    new Clip("#96 Fresh Lychee", "yn0b6mzyTr0", 61.469),
    new Clip("#97 jolo", "hmauAkvGGT8", 61.536),
    new Clip("#98 Chalmers", "rA8dfBJYPCM", 62.324),
    new Clip("#99 herb", "KaiRY9I5KpY", 63.434),
    new Clip("#100 yes", "po2dwoZt2gs", 54.589),
];
var seededIds = [];
